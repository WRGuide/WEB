    ...
    <div class='modal-content'>
      ...
      <div class='modal-body' style='height:160px'>
        <div class='form-group'>
          ...
          <div class='col-xs-2' style='padding:0'>
            <label>Numero</label>
            <input id='modal-tnumber' type='text' class='form-control'>
          </div>
        </div>
      ...
      <div class='modal-footer' style='text-align: left;'>
        <div class='form-inline'>
          <div class='form-group'>` + (modo=="Editar" ?
          ...
          :
          `<input type='button' class='btn btn-primary' id='modal-create' value='Crear'>
          <input type='button' class='btn btn-warning' id='modal-cancel' value='Cancelar'>`)+
          `</div>
        </div>
      </div>
    </div>
