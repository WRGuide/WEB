    ...
    <div class='modal-content'>
      ...
      <div class='modal-body' style='height:230px'>
        <div class='form-group'>
          <div class='col-xs-5' style='padding:0;padding-right:5px'>
          ...
          <div class='col-xs-2' style='padding:0;padding-left:5px'>
            <label>Numero</label>
            <input readonly='' id='modal-tnumber' type='text' class='form-control' style='background-color:#fff'>
          </div>
        </div>
        <div class='form-group'>
          <div class='col-xs-12' style='padding:0;padding-right:5px;margin-bottom:5px'>
